...
`exit(42)` thoát toàn bộ tiến trình và đặt giá trị thoát của tiến trình. Điều này tương đương với `return 42` trong phương thức main. Tất cả các luồng bên trong tiến trình đều bị dừng.
...
Tuy nhiên, khi chạy in ra `1 7 8 8 8 8 8 8 8 10`! Bạn có thể thấy tại sao?
```C
#include <pthread.h>
...
## Có bất kỳ lợi thế nào khi sử dụng luồng hơn so với forking tiến trình không?
...
## Có bất kỳ nhược điểm nào khi sử dụng luồng hơn so với forking tiến trình không?
